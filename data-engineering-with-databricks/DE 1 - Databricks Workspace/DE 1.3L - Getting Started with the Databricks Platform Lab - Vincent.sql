...
-- MAGIC %md
-- MAGIC # My Notebook Title
-- MAGIC * First paragraph
...
-- MAGIC %python
-- MAGIC files = dbutils.fs.ls(f"dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v02/nyctaxi-with-zipcodes/data")
-- MAGIC display(files)
